...
export default function Hero({}: Props) {
  const [text, count] = useTypewriter({
    words: ["Hello", "My name is Elvis","I'm a ['Software', 'Engineering', 'Student'],","<Entrepreneur />, &carLover!"],
    loop: true,
    delaySpeed: 2000
  });
  return (
    <div className='h-screen flex flex-col space-y-8 items-center justify-center text-center overflow-hidden'>
        ...
        <div className='relative rounded-full h-40 w-40 mx-auto object-cover'>
          <Image 
          src='https://cdn.discordapp.com/attachments/705799653848776784/1082208107750510592/IMG_2041_4.JPG'  
          height={1000} width={5000} alt=''/>
        </div>
